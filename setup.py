...
setup(
    ...
    install_requires=[
        'common_analysis_base @ git+https://hub.fastgit.org/mass-project/common_analysis_base.git',
        'common_helper_files @ git+https://hub.fastgit.org/fkie-cad/common_helper_files.git',
        'yara-python >= 3.5'
    ],
    extras_require={
        'dev': [
